...
#%%
val_idx = np.load('CONN_val_idx.npy', allow_pickle=True).item()
non_val_idx = {}
...
#%%#%%
# save the mean accuracies
np.save('mean_accuracies_CONN.npy', mean_accuracies)
np.save('mean_f1_CONN.npy', mean_f1)
np.save('mean_f1_micro_CONN.npy', mean_f1_micro)
np.save('mean_f1_macro_CONN.npy', mean_f1_macro)
#%%