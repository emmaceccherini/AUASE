...
for alpha in alphas: 
    ...
    train_data = [generate_pair_features(pos_pairs[t], neg_pairs[t], YAcs_plot[t], operator_concat) for t in range(T-2)]
    test_data = [generate_pair_features(pos_pairs[T-2], neg_pairs[T-2], YAcs_plot[T-2], operator_concat)]
