...
for i in range(10):
    ...
    train_data = [generate_pair_features(pos_pairs_sample[t], neg_pairs_sample[t], YAcs_plot[t], operator_concat) for t in range(T-2)]
    test_data = [generate_pair_features(pos_pairs_sample[T-2], neg_pairs_sample[T-2], YAcs_plot[T-2], operator_concat)]
